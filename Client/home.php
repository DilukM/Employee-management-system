      ...
      <main>
        ...
        <div class="recent-orders top-table">
          ...
          <table class="table ds-remove">
                    ...
                    <?php
                      $Eid=$_SESSION['Eid'];
                      $sql="SELECT task.Name AS tName,taskactivities.activity AS tActivity,assign.dateassign AS aDate,assign.remarks AS aRemarks, assign.Eid AS aEid FROM task,assign,taskactivities WHERE task.Tid=assign.Tid AND taskactivities.activityid=assign.activityid AND assign.Eid='$Eid'";
